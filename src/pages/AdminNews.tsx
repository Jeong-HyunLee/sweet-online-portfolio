...
import { Plus, Trash2, Edit2, LogOut, Upload, X, FileText, Newspaper, ShieldAlert, KeyRound } from "lucide-react";
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-background px-4">
        <form onSubmit={handleLogin} className="w-full max-w-sm space-y-4 rounded-md border bg-card p-8">
          ...
          <p className="text-sm text-muted-foreground text-center">관리자 계정으로 로그인하세요</p>
          <input
            type="email"
            placeholder="Email"
            value={email}

// ╔══════════════════════════════════════════════════════════════════════╗
// ║  ABOUT / CV DATA — Edit this file to update PI information         ║
// ║                                                                    ║
// ║  HOW TO UPDATE:                                                    ║
// ║  • Add new entries at the TOP of each array (newest first)         ║
// ║  • For grants, include the total amount and funder                 ║
// ╚══════════════════════════════════════════════════════════════════════╝
